...
public class Generator {
    ...
    private static final ArrayList<String> roleContainer = new ArrayList<>(Arrays.asList("Portiere", "Difensore", "Centrocampista", "Attaccante centrale"));
    ...
    //private methods
        ...
        //generation role random TEST
        private static String generateRoleRandom() {
            int indexRandom;
            indexRandom = random.nextInt(roleContainer.size());
            rolePlayer = roleContainer.get(indexRandom);;
            return rolePlayer;
        }
